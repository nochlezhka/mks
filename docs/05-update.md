Елси вы обновляете МКС с версии установленной до 11.11.2022, пожалуйста, обратитесь к разработчикам за помощью
...
0. Создать бекап базы данных и всех статических данных (загруженные картинки и документы)
  ...
  > shared/homeless/public/uploads/images/client/photo

  > shared/homeless/public/uploads/files/
...
12. Возможные проблемы:
	...
	Если после обновления системы не хватает каких-то данных (фотографий, документов), необходимо проверить, что на директорию со статическими данными `shared/homeless/public/uploads/` выставлены правильные права:

    > сhown -R USER:USER /opt/storage/crm.homeless.ru/mks_private/shared/homeless/public/uploads/
