...
class Branch extends BaseEntity
{
    ...
    /**
     * Товары
     * @ORM\ManyToMany(targetEntity="DeliveryItem", inversedBy="branches")
     */
    ...
    public function removeDeliveryItem(DeliveryItem $deliveryItem)
    {
        $this->deliveryItems->removeElement($deliveryItem);
        return $this;
    }
